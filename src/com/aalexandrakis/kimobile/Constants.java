...
public class Constants {
	...
	final static String PROTOCOL = "http://"; //ubuntu & node server
	final static String HOST = "kimo-aalexandrakis.rhcloud.com"; //ubuntu & node server
...
//	final static String REST_URL = URL + "/KimoWebServices/rest/KimoRest/";
	...
	static final String NAMESPACE = "http://kimo-aalexandrakis.rhcloud.com";
