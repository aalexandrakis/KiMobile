...
public class BetsArchive implements Serializable {
	/**
	 * 
	 */
	...
	public BetsArchive(BigInteger betId, String betDateTime, BigInteger userId,
			Integer repeatedDraws, Integer randomChoice, Integer gameType,
			Float betCoins, Integer multiplier, Integer betNumber1,
			Integer betNumber2, Integer betNumber3, Integer betNumber4,
			Integer betNumber5, Integer betNumber6, Integer betNumber7,
			Integer betNumber8, Integer betNumber9, Integer betNumber10,
			Integer betNumber11, Integer betNumber12, String drawTimeStamp,
			Integer matches, Float returnRate, Integer draws) {
		super();
		this.betId = betId;
		this.betDateTime = betDateTime;
		this.userId = userId;
