...
//		coinsToBuy.setText(1);
		...
		CheckoutButton launchPayPalButton = pp.getCheckoutButton(getActivity(), PayPal.BUTTON_278x43, CheckoutButton.TEXT_PAY);
		...
		launchPayPalButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				payment.setRecipient("KiMobile application");
